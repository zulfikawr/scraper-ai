...
interface AppContextType {
  ...
  setScrapeOptions: Dispatch<SetStateAction<ScrapeOptions>>;
  ...
  // Latest server log message for display in the UI
  logMessage: string | null;
  setLogMessage: Dispatch<SetStateAction<string | null>>;

  // Stores the raw/clean hrml output
  html: string;
